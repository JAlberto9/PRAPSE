  ...
  var _TOCNode = declare([_Widget, _Templated], {
    ...
    _createServiceLayerNode: function(serviceLayer){
      ...
      if (serviceLayer._subLayerInfos && serviceLayer._subLayerInfos.length>0) {// group layer
        ...
        this.labelNode.innerHTML += "&nbsp;&nbsp;<a href='" + this.rootLayer.url + "/generatekml?layerOptions=nonComposite&docName=" + getCleanedString(serviceLayer.name) + "&layers=" + serviceLayer.id  + "' class='layerUrl'><img src='imagenes/descarga.png' class='icon'/></a>";
